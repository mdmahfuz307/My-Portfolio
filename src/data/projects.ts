...
export const projects: Project[] = [
  {
    ...
    description: 'This is a Sorting Visaulizer which visualizes different Sorting Algorithms. Implemented 5 most important sorting Algorithms.',
    image: '/images/projects/AV.png',
    tags: ['React', 'Javascript', 'TailwindCSS', 'Netlify'],
    demoLink: 'https://sorting-visualizer307.netlify.app',
    featured: true,
    year: '2025',
    duration: '15 Days',
  ...
  },
  {
    ...
    description: ' This project demonstrates a sleek UI with smooth animations, optimized performance, and a developer-friendly setup.',
    image: '/images/projects/tuduai.png',
    tags: ["React", "Javascript", "TailwindCSS", "Framer Motion", "Netlify"],
    demoLink: 'https://agency-ai-nirobstack.netlify.app/',
    featured: true,
    year: '2025',
    duration: '15 Days',
    color: 'from-indigo-600 to-purple-600'
